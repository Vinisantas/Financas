...
Esse app é um exercício prático de lógica, organização e padrões de código limpo em Python, com o objetivo de evoluir de uma ferramenta de terminal para um sistema web completo.
